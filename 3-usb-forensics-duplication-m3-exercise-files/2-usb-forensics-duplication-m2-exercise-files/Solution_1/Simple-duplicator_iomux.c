/*
** Filename: Simple-duplicator_iomux.c
**
...
void iomux_setup(void)
{
	...
	{
		// GPIO_Port_A_4 to pin 23 as Input.
		vos_iomux_define_input(23, IOMUX_IN_GPIO_PORT_A_4);
		// GPIO_Port_A_5 to pin 24 as Input.
		vos_iomux_define_input(24, IOMUX_IN_GPIO_PORT_A_5);
